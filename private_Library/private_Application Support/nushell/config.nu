...
$env.config = {
    ...
    explore: {
        status_bar_background: {fg: color_palette.color_palette.crust, bg: color_palette.text},
        command_bar_text: {fg: color_palette.text},
        ...
        table: {
            split_line: {fg: color_palette.surface1},
