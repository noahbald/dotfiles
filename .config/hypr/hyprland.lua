...
local terminal = "ghostty +new-window -e nu"
...
hl.bind(mainMod .. " + Q", hl.dsp.exec_cmd("ghostty +new-window -e nu"))
...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("waybar")
    hl.exec_cmd("waybar -c ~/.config/waybar/config-right.jsonc")
    hl.exec_cmd("elephant")
    hl.exec_cmd("walker --gapplication-service")
    hl.exec_cmd("swaybg -i ~/wallpaper.jpg -m fill -c 1E1E2E")
